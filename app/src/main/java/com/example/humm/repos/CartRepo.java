...
public class CartRepo {
    ...
    public boolean addItemToCart(FoodProducts foodProducts) {
        ...
        for (CartItem cartItem: cartItemList) {
            if (cartItem.getFoodProducts().getId().equals(foodProducts.getId())) {
        ...
        CartItem cartItem = new CartItem(foodProducts, 1);
    ...
    public  void changeQuantity(CartItem cartItem, int quantity) {
        ...
        CartItem updatedItem = new CartItem(cartItem.getFoodProducts(), quantity);
    ...
    private void calculateCartTotal() {
        ...
        for (CartItem cartItem: cartItemList) {
            total += cartItem.getFoodProducts().getPrice() * cartItem.getQuantity();
        }
